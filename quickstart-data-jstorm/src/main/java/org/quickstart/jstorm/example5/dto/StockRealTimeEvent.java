...
public class StockRealTimeEvent implements Serializable {
    ...
    public String toString() {
        return "StockRealTimeEvent{" + "stockCode='" + stockCode + '\'' + ", newPrice=" + newPrice + ", buyPrice1=" + buyPrice1 + ", buyCount1=" + buyCount1 + ", buyPrice2=" + buyPrice2
                + ", buyCount2=" + buyCount2 + ", buyPrice3=" + buyPrice3 + ", buyCount3=" + buyCount3 + ", buyPrice4=" + buyPrice4 + ", buyCount4=" + buyCount4 + ", buyPrice5=" + buyPrice5
                + ", buyCount5=" + buyCount5 + ", sellPrice1=" + sellPrice1 + ", sellCount1=" + sellCount1 + ", sellPrice2=" + sellPrice2 + ", sellCount2=" + sellCount2 + ", sellPrice3=" + sellPrice3
                + ", sellCount3=" + sellCount3 + ", sellPrice4=" + sellPrice4 + ", sellCount4=" + sellCount4 + ", sellPrice5=" + sellPrice5 + ", sellCount5=" + sellCount5 + ", current=" + current
                + '}';
    }
}
