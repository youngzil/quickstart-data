...
public class EsClient {
  ...
  public static void addType() throws IOException {
    ...
    XContentBuilder builder = XContentFactory.jsonBuilder().startObject().startObject("blog")
        .startObject("properties").startObject("id").field("type", "integer").field("store", "yes")
        .endObject()
    ...
    PutMappingRequest mappingRequest = Requests.putMappingRequest("test").type("blog")
        .source(builder);
  ...
  public static void createData() throws IOException {
    ...
    XContentBuilder builder = jsonBuilder().startObject().field("id", "2").field("title", "我是标题")
        .field("content", "我是内容").endObject();
    IndexResponse indexResponse = client.prepareIndex("test", "blog").setSource(builder).execute()
        .actionGet();
