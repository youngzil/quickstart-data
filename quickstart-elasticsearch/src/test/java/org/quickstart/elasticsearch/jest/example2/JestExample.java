/**
 * 项目名称：quickstart-elasticsearch 文件名：JestExample.java 版本信息： 日期：2018年8月20日 Copyright asiainfo
...
public class JestExample {
  ...
  public void bulkIndex() throws IOException {
    ...
    Bulk bulk = new Bulk.Builder().defaultIndex(indexName).defaultType(typeName)
        .addAction(Arrays
            .asList(new Index.Builder(csdnBlog1).build(), new Index.Builder(csdnBlog2).build(),
