...
public class RestClientRequest extends ElasticsearchRestClient {
  ...
  public void testSimpleRequest() throws Exception {
    ...
    HttpEntity entity = new NStringEntity(jsonString,
        ContentType.APPLICATION_JSON);// org.apache.http.HttpEntity  为了让Elasticsearch 能够解析,需要设置ContentType。
    ...
    HttpAsyncResponseConsumerFactory.HeapBufferedResponseConsumerFactory consumerFactory =
        new HttpAsyncResponseConsumerFactory.HeapBufferedResponseConsumerFactory(30 * 1024
            * 1024); //[ org.apache.http.nio.protocol.HttpAsyncResponseConsumer](http://hc.apache.org/httpcomponents-core-ga/httpcore-nio/apidocs/org/apache/http/nio/protocol/HttpAsyncResponseConsumer.html) ,
    Response response4 = client
        .performRequest("GET", "/posts/_search", params4, null, consumerFactory);
  ...
  public void testAsyncRequest() throws Exception {
    ...
    client.performRequestAsync("GET", "/posts/_search", params, null, consumerFactory,
        responseListener);
...
//                    documents[i],
  ...
  public void testResponse() throws Exception {
    ...
    String responseBody = EntityUtils
        .toString(response.getEntity()); //response  org.apache.http.HttpEntity 对象
  }
