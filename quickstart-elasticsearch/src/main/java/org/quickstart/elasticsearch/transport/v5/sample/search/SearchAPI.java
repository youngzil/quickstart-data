...
/**
 * 搜索查询，返回查询匹配的结果，搜索一个index / type 或者多个index / type 官方文档 @see <a href='https://www.elastic.co/guide/en/elasticsearch/client/java-api/current/java-search.html'></a>
 * 中文文档 @see <a href='https://es.quanke.name/search-api.html'></a> Created by http://quanke.name on
 * 2017/11/15.
 */
