...
public class ElasticSearchTest {
    ...
    public void before() throws UnknownHostException, InterruptedException, ExecutionException {
        ...
        client.addTransportAddress(new InetSocketTransportAddress(InetAddress.getByName("10.21.20.154"), 9300));
    }
    ...
    public void index() throws Exception {
        ...
        IndexResponse indexResponse2 = client.prepareIndex("test", "info", "101").setSource(infoMap2).execute().actionGet();
    ...
    public void query() throws Exception {
        ...
        SearchResponse searchResponse = client.prepareSearch("test").setTypes("info").setQuery(rangeQueryBuilder).addSort("age", SortOrder.ASC).setSize(20).execute().actionGet();
