...
public class StockStrategyBolt3 extends BaseBasicBolt {
    ...
    public void prepare(Map stormConf, TopologyContext context) {
        ...
        EPStatement stmt = epService.getEPAdministrator().createEPL(
                "select stockCode,newPrice,sum(newPrice*current*100) as totalValue " + "from StockRealTimeEvent.win:time(10 sec) group by stockCode " + "having sum(newPrice*current*100)>10000000");
